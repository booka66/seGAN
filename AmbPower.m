function [powerTable,values,categories, interesting_signal] = AmbPower(signal,sampRate,start,finish,ambient,varargin)
...
if ambient == false
    ...
    %Ambient Power
    [~, ambPowers, ~] = signalBandAnalysis2(signal,sampRate,amb_start,amb_finish,true);
end
...
%center_freq_low2 = center_freq2 - bw/2;
%center_freq_high2 = center_freq2 + bw/2;
